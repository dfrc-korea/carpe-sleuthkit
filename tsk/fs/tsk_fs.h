...
#define TSK_FS_IS_DIR_META(x) ((x == TSK_FS_META_TYPE_DIR) || (x == TSK_FS_META_TYPE_VIRT_DIR))
    ...
    typedef enum TSK_FS_META_CONTENT_TYPE_ENUM {
		...
		TSK_FS_META_CONTENT_TYPE_BTRFS_EXTENTS = 0x05,
		TSK_FS_META_CONTENT_TYPE_BTRFS_INLINE = 0x06,
		TSK_FS_META_CONTENT_TYPE_F2FS_DATA = 0x07,
		TSK_FS_META_CONTENT_TYPE_F2FS_INLINE = 0x08
...
#define  TSK_FS_FILE_TAG 0x11212212
    ...
    */
    enum TSK_FS_TYPE_ENUM {
		...
		TSK_FS_TYPE_XFS = 0x00020000,           ///< XFS file system
		TSK_FS_TYPE_XFS_DETECT = 0x00020000,    ///< XFS auto detection
		TSK_FS_TYPE_BTRFS = 0x00040000,			///< Btrfs file system
		TSK_FS_TYPE_BTRFS_DETECT = 0x00040000,	///< Btrfs auto detection
		TSK_FS_TYPE_HIKVISION = 0x00080000,
		TSK_FS_TYPE_HIKVISION_DETECT = 0x00080000,
		TSK_FS_TYPE_F2FS = 0x00100000,        //F2FS file system
		TSK_FS_TYPE_F2FS_DETECT = 0x00100000,        //F2FS auto detection
...
* \ingroup fslib
* Macro that takes a file system type and returns 1 if the type
* is for an F2FS "file system". */
#define TSK_FS_TYPE_ISF2FS(ftype) \
    (((ftype) & TSK_FS_TYPE_F2FS_DETECT)?1:0)
